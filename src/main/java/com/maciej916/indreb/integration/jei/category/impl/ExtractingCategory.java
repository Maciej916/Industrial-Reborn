...
public class ExtractingCategory extends AbstractRecipeCategory<ExtractingRecipe> {
    ...
    public ExtractingCategory(IGuiHelper guiHelper) {
        super(
                ...
                () -> guiHelper.createDrawableIngredient(new ItemStack(ModBlocks.EXTRACTOR))
        );
    }

    @Override
    public void setIngredients(ExtractingRecipe recipe, IIngredients ingredients) {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, ExtractingRecipe recipe, IIngredients ingredients) {
    ...
    @Override
    public void draw(ExtractingRecipe recipe, PoseStack poseStack, double mouseX, double mouseY) {
    ...
    private class TooltipCallback implements ITooltipCallback<ItemStack> {
        ...
        TooltipCallback(ExtractingRecipe recipe) {
            this.recipe = recipe;
        }
