...
public class SawingCategory extends AbstractRecipeCategory<SawingRecipe> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, SawingRecipe recipe, IFocusGroup focuses) {
        this.progress = guiHelper.drawableBuilder(PROCESS, 26, 68, 24, 16).buildAnimated(recipe.getDuration(), IDrawableAnimated.StartDirection.LEFT, false);
    ...
    @Override
    public void draw(SawingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack poseStack, double mouseX, double mouseY) {
    ...
    private record RecipeSlotTooltipCallback(SawingRecipe recipe) implements IRecipeSlotTooltipCallback {
