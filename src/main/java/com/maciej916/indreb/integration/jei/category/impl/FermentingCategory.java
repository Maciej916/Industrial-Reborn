...
public class FermentingCategory extends AbstractRecipeCategory<FermentingRecipe> {
    ...
    @Override
    public void draw(FermentingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack poseStack, double mouseX, double mouseY) {
        this.progress.draw(poseStack, halfX - 45, 19);
