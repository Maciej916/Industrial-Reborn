...
public abstract class IndRebMenu extends AbstractContainerMenu {
    ...
    public IndRebMenu(@Nullable MenuType<?> pMenuType, int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (slot.hasItem()) {
            ...
            if (index < upgradeSlots) {
                if (!this.moveItemStackTo(stack, upgradeSlots, totalSlots - 1, true)) {
