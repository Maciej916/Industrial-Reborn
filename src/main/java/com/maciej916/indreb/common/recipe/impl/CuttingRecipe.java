...
public class CuttingRecipe implements IRecipeSingleIngredient {

    public static final CuttingRecipe.Serializer SERIALIZER = new CuttingRecipe.Serializer();
    ...
    public CuttingRecipe(ResourceLocation recipeId) {
    ...
    public RecipeType<?> getType() {
        return ModRecipeType.CUTTING.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<CuttingRecipe> {
        ...
        public CuttingRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            CuttingRecipe recipe = new CuttingRecipe(recipeId);
        ...
        @Nullable
        @Override
        public CuttingRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            CuttingRecipe recipe = new CuttingRecipe(recipeId);
