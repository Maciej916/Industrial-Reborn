...
public class CrushingRecipe extends BaseChanceRecipe {
    ...
    public RecipeType<?> getType() {
        return ModRecipeType.CRUSHING.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<CrushingRecipe> {
        ...
        public CrushingRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new CrushingRecipe(recipeId, ingredientCount, result, duration, tickEnergyCost, experience, chanceResult);
        }
