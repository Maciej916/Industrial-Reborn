...
public class ExtractingRecipe extends BaseChanceRecipe {

    public static final Serializer SERIALIZER = new Serializer();

    public ExtractingRecipe(ResourceLocation id, IngredientCount ingredients, ItemStack result, int duration, int tickEnergyCost, float experience, ChanceResult chanceResult) {
    ...
    public static class Serializer implements RecipeSerializer<ExtractingRecipe> {
        ...
        public ExtractingRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new ExtractingRecipe(recipeId, ingredientCount, result, duration, tickEnergyCost, experience, chanceResult);
        }
