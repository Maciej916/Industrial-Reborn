...
public class AdvancedShapedRecipe implements CraftingRecipe, IShapedRecipe<CraftingContainer> {
    ...
    public AdvancedShapedRecipe(ResourceLocation pId, String pGroup, int pWidth, int pHeight, NonNullList<Ingredient> pRecipeItems, ItemStack pResult) {
        this.id = pId;
        this.group = pGroup;
        this.width = pWidth;
        this.height = pHeight;
    ...
    public static class Serializer implements RecipeSerializer<AdvancedShapedRecipe> {
        ...
        public AdvancedShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            Map<String, Ingredient> map = AdvancedShapedRecipe.keyFromJson(GsonHelper.getAsJsonObject(pJson, "key"));
            ...
            NonNullList<Ingredient> nonnulllist = AdvancedShapedRecipe.dissolvePattern(astring, map, i, j);
