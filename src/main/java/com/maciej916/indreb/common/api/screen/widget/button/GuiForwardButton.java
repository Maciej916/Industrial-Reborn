...
public class GuiForwardButton extends BaseButtonWidget {

    List<Component> tooltip;

    public GuiForwardButton(IGuiHelper helper, int x, int y, @Nullable Runnable onLeftClick, List<Component> tooltip) {
