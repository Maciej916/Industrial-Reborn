...
public class GuiUpButton extends GuiButton {

    List<Component> tooltip;

    public GuiUpButton(IGuiWrapper wrapper, int leftOffset, int topOffset, Runnable leftClick, List<Component> tooltip) {
