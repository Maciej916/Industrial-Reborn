...
public class GuiDownButton extends GuiButton {

    List<Component> tooltip;

    public GuiDownButton(IGuiWrapper wrapper, int leftOffset, int topOffset, Runnable leftClick, List<Component> tooltip) {
    ...
    protected void renderBg(PoseStack pPoseStack, Minecraft pMinecraft, int pMouseX, int pMouseY) {
        ...
        GuiSprite sprite = GuiSprite.DOWN_ICON;
