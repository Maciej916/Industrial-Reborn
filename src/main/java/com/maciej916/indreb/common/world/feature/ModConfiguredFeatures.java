...
import com.maciej916.indreb.common.world.feature.tree.RubberFoliagePlacer;
import com.maciej916.indreb.common.world.feature.tree.RubberTreeBlockStateProvider;
...
public class ModConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> ORE_URANIUM_TARGET_LIST = Suppliers.memoize(() -> List.of(OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_URANIUM_ORE.get().defaultBlockState())));
