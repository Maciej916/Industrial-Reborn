...
public class SulfuricAcid {
    ...
    public static final ResourceLocation STILL_TEXTURE = new ResourceLocation(IndReb.MODID,"/block/fluid/sulfuric_acid/sulfuric_acid_still");
    public static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation(IndReb.MODID,"/block/fluid/sulfuric_acid/sulfuric_acid_flow");
    public static final ResourceLocation OVERLAY_TEXTURE = new ResourceLocation(IndReb.MODID,"/block/fluid/sulfuric_acid/sulfuric_acid_overlay");
    ...
    public static FluidType FluidType() {
        FLUID_TYPE = new BaseFluidType(
                ...
                OVERLAY_TEXTURE,
                0XA1e9d700,
                new Vector3f(233f / 255f, 215f / 227f, 0f / 255f),
