...
public class BlockEntityOreWashingPlant extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IBlockEntityFluid, IHasSound {
    ...
    public BlockEntityOreWashingPlant(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityOreWashingPlant.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityOreWashingPlant.this.progressRecipe.getContainerDataMax();
                    case 2 -> BlockEntityOreWashingPlant.this.progressFill.getContainerDataCurrent();
                    case 3 -> BlockEntityOreWashingPlant.this.progressFill.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityOreWashingPlant.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityOreWashingPlant.this.progressRecipe.setContainerDataMax(value);
                    case 2 -> BlockEntityOreWashingPlant.this.progressFill.setContainerDataCurrent(value);
                    case 3 -> BlockEntityOreWashingPlant.this.progressFill.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuOreWashingPlant(this, containerId, playerInventory, player, data);
    }
