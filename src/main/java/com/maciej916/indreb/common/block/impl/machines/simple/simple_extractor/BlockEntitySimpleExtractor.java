...
public class BlockEntitySimpleExtractor extends IndRebBlockEntity implements IHasExp {
    ...
    public BlockEntitySimpleExtractor(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntitySimpleExtractor.this.progressBurn.getContainerDataCurrent();
                    case 1 -> BlockEntitySimpleExtractor.this.progressBurn.getContainerDataMax();
                    case 2 -> BlockEntitySimpleExtractor.this.progressSmelting.getContainerDataCurrent();
                    case 3 -> BlockEntitySimpleExtractor.this.progressSmelting.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntitySimpleExtractor.this.progressBurn.setContainerDataCurrent(value);
                    case 1 -> BlockEntitySimpleExtractor.this.progressBurn.setContainerDataMax(value);
                    case 2 -> BlockEntitySimpleExtractor.this.progressSmelting.setContainerDataCurrent(value);
                    case 3 -> BlockEntitySimpleExtractor.this.progressSmelting.setContainerDataMax(value);
                }
            }
