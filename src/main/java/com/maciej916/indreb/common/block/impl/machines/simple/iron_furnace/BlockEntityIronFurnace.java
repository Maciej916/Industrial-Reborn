...
public class BlockEntityIronFurnace extends IndRebBlockEntity implements IHasExp {
    ...
    public BlockEntityIronFurnace(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityIronFurnace.this.progressBurn.getContainerDataCurrent();
                    case 1 -> BlockEntityIronFurnace.this.progressBurn.getContainerDataMax();
                    case 2 -> BlockEntityIronFurnace.this.progressSmelting.getContainerDataCurrent();
                    case 3 -> BlockEntityIronFurnace.this.progressSmelting.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityIronFurnace.this.progressBurn.setContainerDataCurrent(value);
                    case 1 -> BlockEntityIronFurnace.this.progressBurn.setContainerDataMax(value);
                    case 2 -> BlockEntityIronFurnace.this.progressSmelting.setContainerDataCurrent(value);
                    case 3 -> BlockEntityIronFurnace.this.progressSmelting.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuIronFurnace(this, containerId, playerInventory, player, data);
    }
