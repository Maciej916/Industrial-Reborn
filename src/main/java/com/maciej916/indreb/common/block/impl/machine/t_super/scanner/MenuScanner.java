...
public class MenuScanner extends IndRebContainerMenu {

    public MenuScanner(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
    ...
    public MenuScanner(IndRebBlockEntity entity, int containerId, Inventory playerInventory, Player player, ContainerData data) {
        super(ModMenuTypes.SCANNER.get(), entity, containerId, playerInventory, player, data);
    }
