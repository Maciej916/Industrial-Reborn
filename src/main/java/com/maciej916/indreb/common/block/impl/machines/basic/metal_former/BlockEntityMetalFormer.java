...
public class BlockEntityMetalFormer extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IHasSound {
    ...
    public BlockEntityMetalFormer(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityMetalFormer.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityMetalFormer.this.progressRecipe.getContainerDataMax();
                    case 2 -> BlockEntityMetalFormer.this.getMode().getId();
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityMetalFormer.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityMetalFormer.this.progressRecipe.setContainerDataMax(value);
                    case 2 -> BlockEntityMetalFormer.this.setMode(MetalFormerMode.getModeFromId(index));
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuMetalFormer(this, containerId, playerInventory, player, data);
    }
