...
public class MenuBatteryBox extends IndRebContainerMenu {

    public MenuBatteryBox(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
    ...
    public MenuBatteryBox(IndRebBlockEntity entity, int containerId, Inventory playerInventory, Player player, ContainerData data) {
        super(ModMenuTypes.BATTERY_BOX.get(), entity, containerId, playerInventory, player, data);
    }
