...
public class BlockEntityElectricFurnace extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy {
    ...
    public BlockEntityElectricFurnace(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityElectricFurnace.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityElectricFurnace.this.progressRecipe.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityElectricFurnace.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityElectricFurnace.this.progressRecipe.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuElectricFurnace(this, containerId, playerInventory, player, data);
    }
