...
public class BlockEntityFermenter extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IBlockEntityFluid,IHasSound {
    ...
    public static final int SYNC_DATA_SLOTS = 10;
    ...
    public Progress progressDrain = new Progress(0, 1);
    public Progress progressWaste = new Progress();
    ...
    public BlockEntityFermenter(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityFermenter.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityFermenter.this.progressRecipe.getContainerDataMax();
                    case 2 -> BlockEntityFermenter.this.progressHeat.getContainerDataCurrent();
                    case 3 -> BlockEntityFermenter.this.progressHeat.getContainerDataMax();
                    case 4 -> BlockEntityFermenter.this.progressFill.getContainerDataCurrent();
                    case 5 -> BlockEntityFermenter.this.progressFill.getContainerDataMax();
                    case 6 -> BlockEntityFermenter.this.progressDrain.getContainerDataCurrent();
                    case 7 -> BlockEntityFermenter.this.progressDrain.getContainerDataMax();
                    case 8 -> BlockEntityFermenter.this.progressWaste.getContainerDataCurrent();
                    case 9 -> BlockEntityFermenter.this.progressWaste.getContainerDataMax();
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityFermenter.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityFermenter.this.progressRecipe.setContainerDataMax(value);
                    case 2 -> BlockEntityFermenter.this.progressHeat.setContainerDataCurrent(value);
                    case 3 -> BlockEntityFermenter.this.progressHeat.setContainerDataMax(value);
                    case 4 -> BlockEntityFermenter.this.progressFill.setContainerDataCurrent(value);
                    case 5 -> BlockEntityFermenter.this.progressFill.setContainerDataMax(value);
                    case 6 -> BlockEntityFermenter.this.progressDrain.setContainerDataCurrent(value);
                    case 7 -> BlockEntityFermenter.this.progressDrain.setContainerDataMax(value);
                    case 8 -> BlockEntityFermenter.this.progressWaste.setContainerDataCurrent(value);
                    case 9 -> BlockEntityFermenter.this.progressWaste.setContainerDataMax(value);
                }
            }
    ...
    public void tickWork() {
        ...
        if (recipe != null) {
            ...
            if (progressWaste.currentProgress() == -1) {
            ...
            if (
                    ...
                    ((progressWaste.currentProgress() + recipe.getTickWasteIncrease() >= recipe.getWasteDuration() && wasteStack.getCount() < getBaseStorage().getSlotLimit(WASTE_SLOT)) || progressWaste.currentProgress() + recipe.getTickWasteIncrease() < recipe.getWasteDuration()) &&
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuFermenter(this, containerId, playerInventory, player, data);
    }
