...
public class BlockEntitySimpleCrusher extends IndRebBlockEntity implements IHasExp {
    ...
    public BlockEntitySimpleCrusher(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntitySimpleCrusher.this.progressBurn.getContainerDataCurrent();
                    case 1 -> BlockEntitySimpleCrusher.this.progressBurn.getContainerDataMax();
                    case 2 -> BlockEntitySimpleCrusher.this.progressSmelting.getContainerDataCurrent();
                    case 3 -> BlockEntitySimpleCrusher.this.progressSmelting.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntitySimpleCrusher.this.progressBurn.setContainerDataCurrent(value);
                    case 1 -> BlockEntitySimpleCrusher.this.progressBurn.setContainerDataMax(value);
                    case 2 -> BlockEntitySimpleCrusher.this.progressSmelting.setContainerDataCurrent(value);
                    case 3 -> BlockEntitySimpleCrusher.this.progressSmelting.setContainerDataMax(value);
                }
            }
