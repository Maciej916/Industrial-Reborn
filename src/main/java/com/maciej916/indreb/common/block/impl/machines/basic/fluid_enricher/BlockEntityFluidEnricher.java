...
public class BlockEntityFluidEnricher extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IBlockEntityFluid, IHasSound {
    ...
    public static final int SYNC_DATA_SLOTS = 6;
    ...
    public BlockEntityFluidEnricher(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityFluidEnricher.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityFluidEnricher.this.progressRecipe.getContainerDataMax();
                    case 2 -> BlockEntityFluidEnricher.this.progressFill.getContainerDataCurrent();
                    case 3 -> BlockEntityFluidEnricher.this.progressFill.getContainerDataMax();
                    case 4 -> BlockEntityFluidEnricher.this.progressDrain.getContainerDataCurrent();
                    case 5 -> BlockEntityFluidEnricher.this.progressDrain.getContainerDataMax();
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityFluidEnricher.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityFluidEnricher.this.progressRecipe.setContainerDataMax(value);
                    case 2 -> BlockEntityFluidEnricher.this.progressFill.setContainerDataCurrent(value);
                    case 3 -> BlockEntityFluidEnricher.this.progressFill.setContainerDataMax(value);
                    case 4 -> BlockEntityFluidEnricher.this.progressDrain.setContainerDataCurrent(value);
                    case 5 -> BlockEntityFluidEnricher.this.progressDrain.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuFluidEnricher(this, containerId, playerInventory, player, data);
    }
