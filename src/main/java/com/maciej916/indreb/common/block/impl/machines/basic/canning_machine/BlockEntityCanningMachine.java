...
public class BlockEntityCanningMachine extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IHasSound {
    ...
    public BlockEntityCanningMachine(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityCanningMachine.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityCanningMachine.this.progressRecipe.getContainerDataMax();
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityCanningMachine.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityCanningMachine.this.progressRecipe.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuCanningMachine(this, containerId, playerInventory, player, data);
    }
