...
public class BlockEntityRecycler extends IndRebBlockEntity implements IHasExp, IHasUpgrades, IBlockEntityEnergy, IHasSound {
    ...
    public BlockEntityRecycler(BlockPos pos, BlockState blockState) {
        ...
        this.data = new ContainerData() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> BlockEntityRecycler.this.progressRecipe.getContainerDataCurrent();
                    case 1 -> BlockEntityRecycler.this.progressRecipe.getContainerDataMax();
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> BlockEntityRecycler.this.progressRecipe.setContainerDataCurrent(value);
                    case 1 -> BlockEntityRecycler.this.progressRecipe.setContainerDataMax(value);
                }
            }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new MenuRecycler(this, containerId, playerInventory, player, data);
    }
