...
public class MenuThermalCentrifuge extends IndRebContainerMenu {
    ...
    public MenuThermalCentrifuge(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
        this((IndRebBlockEntity) playerInventory.player.level.getBlockEntity(extraData.readBlockPos()), containerId, playerInventory, playerInventory.player, new SimpleContainerData(BlockEntityThermalCentrifuge.SYNC_DATA_SLOTS));
    }
