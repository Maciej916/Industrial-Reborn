...
public class ModPlacedFeatures {
    ...
    public static void init() {
        RUBBER_TREE_STANDARD = register("rubber_tree_standard", ModConfiguredFeatures.RUBBER_TREE.placed(PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(ModBlocks.RUBBER_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
        RUBBER_TREE_RICH = register("rubber_tree_rich", ModConfiguredFeatures.RUBBER_TREE.placed(PlacementUtils.countExtra(0, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(ModBlocks.RUBBER_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
