...
public class ReactorComponentCapability implements IReactorComponentCapability, ICapabilitySerializable<CompoundTag> {
    ...
    protected int minEUGenerated = Integer.MAX_VALUE;
    protected int maxEUGenerated = 0;
    ...
    public int getMinEUGenerated() { return minEUGenerated; }
    public int getMaxEUGenerated() { return maxEUGenerated; }
