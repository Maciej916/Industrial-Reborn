...
public class CanningRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 4)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 5)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 1)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 3)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 6)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 8)
        ...
        CanningRecipeBuilder.builder(ModItems.FILLED_TIN_CAN, 2)
