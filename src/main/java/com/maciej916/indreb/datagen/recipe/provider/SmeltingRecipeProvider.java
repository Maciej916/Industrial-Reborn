...
public class SmeltingRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_TIN), ModItems.TIN_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_ORE_TIN), ModItems.TIN_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_TIN), ModItems.TIN_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_LEAD), ModItems.LEAD_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_ORE_LEAD), ModItems.LEAD_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_LEAD), ModItems.LEAD_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_URANIUM), ModItems.URANIUM_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_ORE_URANIUM), ModItems.URANIUM_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_URANIUM), ModItems.URANIUM_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_SILVER), ModItems.SILVER_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_ORE_SILVER), ModItems.SILVER_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_SILVER), ModItems.SILVER_INGOT.get(), 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_COPPER), Items.COPPER_INGOT, 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_IRON), Items.IRON_INGOT, 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.FORGE_DUSTS_GOLD), Items.GOLD_INGOT, 0.8f, 200)
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItems.REINFORCED_STONE.get()), ModItems.SMOOTH_REINFORCED_STONE.get(), 0.1f, 200)
