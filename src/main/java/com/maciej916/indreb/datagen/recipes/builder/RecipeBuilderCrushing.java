...
public class RecipeBuilderCrushing {
    ...
    public RecipeBuilderCrushing(ItemStack result, int duration, int powerCost, float experience) {
        this.result = result;
    ...
    public RecipeBuilderCrushing setBonus(ItemLike itemIn, int count, int chance) {
    ...
    public RecipeBuilderCrushing setIngredient(Tag<Item> tag, int count) {
    ...
    public RecipeBuilderCrushing setPowerCost(int powerCost) {
        this.powerCost = powerCost;
        return this;
    }
