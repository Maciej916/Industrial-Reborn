...
public class RecipeBuilderCutting {
    ...
    public RecipeBuilderCutting(ItemStack result, int duration, int powerCost, float experience) {
        this.result = result;
    ...
    public static RecipeBuilderCutting builder(ItemLike item, int resultCount) {
        return new RecipeBuilderCutting(new ItemStack(item, resultCount), 180, 8, 0);
    }

    public RecipeBuilderCutting setIngredient(Ingredient ingredient, int count) {
        this.ingredient = ingredient;
        this.ingredientCount = count;
        return this;
    }

    public RecipeBuilderCutting setIngredient(ItemLike item, int count) {
        return setIngredient(Ingredient.of(item), count);
    }

    public RecipeBuilderCutting setIngredient(TagKey<Item> tag, int count) {
        return setIngredient(Ingredient.of(tag), count);
    }

    public RecipeBuilderCutting setDuration(int duration) {
        this.duration = duration;
        return this;
    }

    public RecipeBuilderCutting setPowerCost(int powerCost) {
        this.powerCost = powerCost;
        return this;
    }

    public RecipeBuilderCutting setExperience(float experience) {
        this.experience = experience;
        return this;
    }

    public RecipeBuilderCutting addCriterion(String name, CriterionTriggerInstance criterionIn) {
        this.advancementBuilder.addCriterion(name, criterionIn);
        return this;
    }

    public RecipeBuilderCutting setGroup(String groupIn) {
        this.group = groupIn;
        return this;
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        private final RecipeBuilderCutting builder;

        public Result(ResourceLocation id, RecipeBuilderCutting builder) {
            this.id = id;
