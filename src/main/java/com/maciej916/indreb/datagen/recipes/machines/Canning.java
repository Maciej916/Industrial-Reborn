...
public class Canning extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 4)
                .setFirstIngredient(Items.APPLE, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 4)
                .setExperience(0.2F)
                .addCriterion("apple", InventoryChangeTrigger.TriggerInstance.hasItems(Items.APPLE))
                .addCriterion("tin_can", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.TIN_CAN.get()))
                .setGroup("canning")
                .save(consumer,"apple");


        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 5)
                .setFirstIngredient(Items.BAKED_POTATO, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 5)
                .setExperience(0.2F)
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 1)
                .setFirstIngredient(Items.BEETROOT, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 1)
                .setExperience(0.2F)
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 3)
                .setFirstIngredient(Items.CARROT, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 3)
                .setExperience(0.2F)
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 6)
                .setFirstIngredient(Items.COOKED_MUTTON, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 6)
                .setExperience(0.2F)
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 8)
                .setFirstIngredient(Items.COOKED_PORKCHOP, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 8)
                .setExperience(0.2F)
        ...
        RecipeBuilderCanning.builder(ModItems.FILLED_TIN_CAN.get(), 2)
                .setFirstIngredient(Items.COOKIE, 1)
                .setSecondIngredient(ModItems.TIN_CAN.get(), 2)
                .setExperience(0.2F)
