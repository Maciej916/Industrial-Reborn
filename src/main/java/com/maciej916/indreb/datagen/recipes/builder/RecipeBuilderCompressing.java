...
public class RecipeBuilderCompressing {
    ...
    public RecipeBuilderCompressing(ItemStack result, int duration, int powerCost, float experience) {
        this.result = result;
    ...
    public static RecipeBuilderCompressing builder(ItemLike item, int resultCount) {
        return new RecipeBuilderCompressing(new ItemStack(item, resultCount), 180, 8, 0);
    }

    public RecipeBuilderCompressing setBonus(ItemLike itemIn, int count, int chance) {
        this.bonusResult = this.bonusResult.addChanceResult(new ItemStack(itemIn, count), chance);
        return this;
    }

    public RecipeBuilderCompressing setIngredient(Ingredient ingredient, int count) {
        this.ingredient = ingredient;
        this.ingredientCount = count;
        return this;
    }

    public RecipeBuilderCompressing setIngredient(ItemLike item, int count) {
    ...
    public RecipeBuilderCompressing setDuration(int duration) {
        this.duration = duration;
        return this;
    }

    public RecipeBuilderCompressing setPowerCost(int powerCost) {
        this.powerCost = powerCost;
        return this;
    }

    public RecipeBuilderCompressing setExperience(float experience) {
        this.experience = experience;
        return this;
    }

    public RecipeBuilderCompressing addCriterion(String name, CriterionTriggerInstance criterionIn) {
        this.advancementBuilder.addCriterion(name, criterionIn);
        return this;
    }

    public RecipeBuilderCompressing setGroup(String groupIn) {
        this.group = groupIn;
        return this;
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        private final RecipeBuilderCompressing builder;

        public Result(ResourceLocation id, RecipeBuilderCompressing builder) {
            this.id = id;
